...
export const MVP_CANDIDATES_WITH_POINTS = [
  { name: 'Shai Gilgeous-Alexander', team: 'Oklahoma City Thunder', points: 10, avatar: "/resources/nba-players-avatars/SGA.png" },
  { name: 'Jayson Tatum', team: 'Boston Celtics', points: 12, avatar: "/resources/nba-players-avatars/tatum.png" },
  { name: 'Donovan Mitchell', team: 'Cleveland Cavaliers', points: 14, avatar: "/resources/nba-players-avatars/donovan.png" },
  ...
  { name: 'Evan Mobley', team: 'Cleveland Cavaliers', points: 27, avatar: "/resources/nba-players-avatars/mobley.png" },
  { name: 'Jalen Brunson', team: 'New York Knicks', points: 27, avatar: "/resources/nba-players-avatars/jalen-brunson.png" },
  { name: 'Kristaps Porzingis', team: 'Golden State Warriors', points: 27, avatar: "/resources/nba-players-avatars/kristaps-porzingis.png" },
  { name: 'Chet Holmgren', team: 'Oklahoma City Thunder', points: 29, avatar: "/resources/nba-players-avatars/chet-holmgren.png" },
  { name: 'Anthony Edwards', team: 'Minnesota Timberwolves', points: 30, avatar: "/resources/nba-players-avatars/ant.png" },
  { name: 'Derrick White', team: 'Boston Celtics', points: 30, avatar: "/resources/nba-players-avatars/derrick-white.png" },
  { name: 'Karl Anthony Towns', team: 'New York Knicks', points: 30, avatar: "/resources/nba-players-avatars/karl-anthony-towns.png" },
  { name: 'Jimmy Butler', team: 'Golden State Warriors', points: 33, avatar: "/resources/nba-players-avatars/jimmy-butler.png" },
  { name: 'Giannis Antetokounmpo', team: 'Milwaukee Bucks', points: 37, avatar: "/resources/nba-players-avatars/giannis.png" },
