...
const CHECK_CONFIG = {
  orphanedPredictions: {
    ...
    columns: [
      { key: 'predictionId', label: 'Prediction ID' },
  ...
  scoreMismatches: {
    ...
    columns: [
      ...
      { key: 'storedTotal', label: 'Stored' },
      { key: 'expectedTotal', label: 'Expected' },
    ],
  },
  unscoredPredictions: {
    ...
    columns: [
      { key: 'predictionId', label: 'Prediction ID' },
      { key: 'predictedScore', label: 'Predicted' },
      { key: 'actualScore', label: 'Actual' },
    ],
  },
  invalidMatchupScores: {
    ...
    columns: [
      { key: 'matchupId', label: 'Matchup ID' },
      { key: 'round', label: 'Round' },
      { key: 'homeTeamScore', label: 'Home' },
      { key: 'awayTeamScore', label: 'Away' },
    ],
  },
  staleChampionshipPoints: {
    ...
    columns: [
      ...
      { key: 'championshipTeamPoints', label: 'Points' },
    ],
  },
