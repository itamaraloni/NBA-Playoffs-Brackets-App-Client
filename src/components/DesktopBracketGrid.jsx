...
const DesktopBracketGrid = ({ bracket, isLocked, onMatchupClick, bonusPicks, scoringConfig }) => {
  ...
  // Card wrapper with hover handlers + staggered animation delay
      ...
      <Box sx={{
        ...
        {westSurvivor && (
          <>
            ...
            <HoverCard data-card-id="w-surv" data-feeds="w-pi-1,w-pi-2">
              <BracketMatchup matchup={westSurvivor} isLocked={isLocked} onMatchupClick={onMatchupClick} compact />
            </HoverCard>
          </>
        )}
        {westPlayin.map((m) => (
          <HoverCard key={m.matchup_position} data-card-id={`w-pi-${m.matchup_position}`} data-feeds="">
      ...
      <Box sx={{
        ...
        {eastSurvivor && (
          <>
            ...
            <HoverCard data-card-id="e-surv" data-feeds="e-pi-1,e-pi-2">
              <BracketMatchup matchup={eastSurvivor} isLocked={isLocked} onMatchupClick={onMatchupClick} compact />
            </HoverCard>
          </>
        )}
        {eastPlayin.map((m) => (
          <HoverCard key={m.matchup_position} data-card-id={`e-pi-${m.matchup_position}`} data-feeds="">
            <BracketMatchup matchup={m} isLocked={isLocked} onMatchupClick={onMatchupClick} compact />
          </HoverCard>
        ))}
      </Box>
